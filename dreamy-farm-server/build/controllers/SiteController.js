  ...
  function SiteController() {
    ...
    _defineProperty(this, "search", /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var _req$query, page, limit, keySearch, productsResult, recipesResult, total, data, dataResult, response;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _req$query = req.query, page = _req$query.page, limit = _req$query.limit, keySearch = _req$query.keySearch;
              _context2.next = 4;
              return _this.searchAtModel({
                keySearch: keySearch,
                sort: 'sold,desc',
            ...
            case 4:
              productsResult = _context2.sent;
              productsResult.data = productsResult.data.map(function (item) {
                return _objectSpread(_objectSpread({}, item._doc), {}, {
                  typeSearch: 'product'
                });
              });
              _context2.next = 8;
            ...
            case 8:
              recipesResult = _context2.sent;
              recipesResult.data = recipesResult.data.map(function (item) {
                return _objectSpread(_objectSpread({}, item._doc), {}, {
                  typeSearch: 'recipe'
                });
              });
              ...
              // combine 2 array
              total = productsResult.total + recipesResult.total;
              data = [].concat(_toConsumableArray(productsResult.data), _toConsumableArray(recipesResult.data)); // priority: product > recipe
              dataResult = data.slice(0, productsResult.limit);
              response = {
                status: 'success',
